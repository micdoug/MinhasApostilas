  ...
  <td align="right" valign="top">
    <table cellspacing="0" cellpadding="1"><col><col><tbody>
      <tr>
         ...
         <td align="left" valign="top"><font size="2" class="txt_with_shadow">QxOrm 1.2.9 - <a href="../doxygen/index.html" target="_blank">QxOrm library online documentation</a></font></td>
      </tr>
      <tr>
  ...
  <tbody>
    <tr>
      <td align="justify">
         ...
         <br/>
         <a href="../php/add_download.php5?file_path=QxOrm_1.2.9.zip&file_desc=QxOrm_1.2.9" class="btn_tuto" target="_blank">Download QxOrm 1.2.9</a>
         <br/>
         <!--
...
function checkForm(f) { f.submit(); return true; }
         ...
         <form action="../php/add_download.php" method="POST" onSubmit="return checkForm(this);">
            ...
            <input type="submit" value="            Download QxOrm 1.2.9            " />
         </form>
         -->
         <br>
      </td>
